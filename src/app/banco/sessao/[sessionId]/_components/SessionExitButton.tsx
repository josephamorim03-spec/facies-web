...
export function SessionExitButton({
  ...
  return (
    <button
      ...
      className={`inline-flex shrink-0 items-center gap-1 rounded-control border border-edge bg-paper px-2 py-1.5 text-xs text-muted transition hover:text-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary ${className}`}
    >
