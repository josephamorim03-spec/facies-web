          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                type="button"
                onClick={onExit}
                className="border border-edge px-3 py-2 text-xs font-semibold text-muted transition-colors hover:border-primary hover:text-ink"
              >
                Sair
              </button>
            </div>
        ...
        <div className="mx-auto flex max-w-4xl items-center justify-end gap-2">
          {!revealed && picked !== null && (
            <button
              type="button"
              onClick={reveal}
              className="border border-primary bg-primary px-5 py-2 text-sm font-semibold text-primaryInk "
            >
              Ver resposta
            </button>
          )}
          {!revealed && picked === null && (
            <button type="button" onClick={next} className="border border-edge px-4 py-2 text-sm font-semibold text-muted transition-colors hover:border-primary hover:text-ink">
              Pular
            </button>
          )}
          {revealed && (
