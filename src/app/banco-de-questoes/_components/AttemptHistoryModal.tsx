  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-ink/40 p-4" onClick={onClose}>
      <div
        ...
        className="flex max-h-[80vh] w-full max-w-md flex-col rounded-lg border border-edge bg-paper p-5 shadow-lg"
      ...
      >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex shrink-0 items-center gap-1.5">
                      {attempt.doubtful && (
                        <span className="rounded-full border border-warning/40 px-2 py-0.5 text-[11px] font-semibold text-warning">
                          Em dúvida
                        </span>
                      )}
                      <span
        ...
        <button
          type="button"
          onClick={onClose}
          className="mt-4 w-full rounded-lg border border-edge px-4 py-2 text-sm font-semibold text-ink hover:border-primary"
        >
          Fechar
        </button>
      </div>
