...
// Gráficos, sem nada de simulados à vista. O historico virou rota propria em
// `/banco/historico`; quando o filtro por tipo voltar, o deep-link volta com ele.
export default function ProvasPage() {
  redirect("/banco/historico");
}
