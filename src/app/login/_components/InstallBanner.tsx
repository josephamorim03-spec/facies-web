...
export function InstallBanner({
  ...
  return (
    <div className="md:hidden fixed inset-x-0 bottom-[calc(env(safe-area-inset-bottom,0px)+0.75rem)] z-40 flex flex-col items-center px-4 pointer-events-none">
      <button
        type="button"
        className="pointer-events-auto flex items-center gap-2 rounded-control border border-edge bg-paper px-3 py-2"
        onClick={onInstall}
      ...
      >
        ...
        <Image src="/apple-touch-icon.png" alt="Fácies" width={24} height={24} className="w-6 h-6 " />
