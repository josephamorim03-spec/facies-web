...
export function IconRefresh({ className }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      <path d="M21.5 2v6h-6" /><path d="M2.5 12a9 9 0 0 1 15.1-6.6L21.5 8" /><path d="M2.5 22v-6h6" /><path d="M21.5 12a9 9 0 0 1-15.1 6.6L2.5 16" />
    </svg>
  );
}

export function IconStethoscope({ className, title }: { className?: string; title?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      {title ? <title>{title}</title> : null}
      <circle cx="6" cy="3" r="1" />
      <circle cx="18" cy="3" r="1" />
      <path d="M6 4 C6 9 12 9 12 13" />
      <path d="M18 4 C18 9 12 9 12 13" />
...
export function IconCritical({ className }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 18" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      <path d="M10 1L19 17H1L10 1Z" />
      <line x1="10" y1="7" x2="10" y2="11" strokeWidth="2" />
      <line x1="10" y1="14" x2="10.01" y2="14" strokeWidth="2" />
    </svg>
  );
}
