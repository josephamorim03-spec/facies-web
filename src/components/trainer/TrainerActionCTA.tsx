...
export function TrainerActionCTA({
  ...
  const baseClass =
    "inline-flex items-center justify-center gap-2 rounded-surface border border-primary bg-primary px-4 py-2.5 text-sm font-semibold text-primaryInk shadow-sm transition hover:brightness-105 disabled:opacity-60";
