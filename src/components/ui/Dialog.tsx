  ...
  return (
    <DialogPrimitive.Root open={open} onOpenChange={onOpenChange}>
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content className={`paper-overlay fixed left-1/2 top-1/2 z-[71] max-h-[min(85dvh,48rem)] w-[min(calc(100vw-2rem),34rem)] -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded-xl border border-edge bg-surface p-5 focus:outline-none ${className}`.trim()}>
